...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    car: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCategorieCategorie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    viewType: Schema.Attribute.Enumeration<['single', 'card']>;
  };
}
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String & Schema.Attribute.Required;
    details: Schema.Attribute.Component<'shared.post-details', true> &
      Schema.Attribute.Required;
